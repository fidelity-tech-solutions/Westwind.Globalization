...
{
    [TestFixture]
    public class DbResourcePostgreSqlDataManagerTests
    {
        ...
        private Westwind.Globalization.DbResourcePostgreSqlDataManager GetManager()
        {
        ...
        public void GetAllResourceIds()
        {
            ...
            var items = manager.GetAllResourceIds("Resources", "en");
            Assert.IsNotNull(items,manager.ErrorMessage);
            Assert.IsTrue(items.Count > 0);
        }
        ...
        {
            var manager = GetManager();
            var items = manager.GetAllResourceIdListItems("Resources", "en");
